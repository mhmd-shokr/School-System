                                                                                            ...
                                                                                            <div class="col">
                                                                                                ...
                                                                                                <select name="Grade_id"
                                                                                                    ...
                                                                                                    @foreach ($list_Grades as $list_Grade)
                                                                                                        <option
                                                                                                            value="{{ $list_Grade->id }}" {{ $list_Sections->Grade_id == $list_Grade->id ? 'selected' : '' }}>
                                                                                                            {{ $list_Grade->Name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                        ...
                                        <div class="col">
                                            <label for="inputName"
                                                class="control-label">{{ trans('section_trans.Name_Grade') }}</label>
                                                {{-- when change in nameGrade take $grade->id selected and send it to console --}}
                                                <select name="Grade_id" class="custom-select"
                                                onchange="console.log($(this).val())">
                                                <!--placeholder-->
                                                <option value="" selected disabled>
                                                    {{ trans('section_trans.Select_Grade') }}
                                                </option>
                                                @foreach ($list_Grades as $list_Grade)
